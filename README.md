[![Run App MasonShimek](https://github.com/m-shimek/GithubActionsLab/actions/workflows/run-app.yaml/badge.svg)](https://github.com/m-shimek/GithubActionsLab/actions/workflows/run-app.yaml)
